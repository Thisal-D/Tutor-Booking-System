...
public class UserManager { // dependency
    ...
    public static void readUsers() { /* reads user data from users.txt, and initializes the users list */
        ...
        for (String userData : usersDataArr) {
            ...
            User user = new User(userID, email, password, name, contactNo, age, gender); // Create a User object with
                                                                                         // those fields
            users.add(user);
        }
    ...
    public static void saveUsersToFile() {
        /*
         * Converts all user objects in users list to string format and saves,
         * overwriting it
         */
